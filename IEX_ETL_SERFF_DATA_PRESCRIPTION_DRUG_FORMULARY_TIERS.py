# title: IEX_ETL_SERFF_DATA_PRESCRIPTION_DRUG_FORMULARY_TIERS.py
...
excel_sheet_names = ['Formulary Tiers']
sheet_name = 'FORMULARY_TIERS'
...
all_data.columns = [
    ...
    'formulary_id','formulary_url', 'drug_list_id', 'number_of_tiers', 'drug_tier_id', 'drug_tier_type',
    'one_month_in_network_retail_pharmacy_copayment', 'one_month_in_network_retail_pharmacy_coinsurance',
    'one_month_out_of_network_retail_pharmacy_benefit_offered',
    'one_month_out_of_network_retail_pharmacy_copayment',
    'one_month_out_of_network_retail_pharmacy_coinsurance',
    'three_month_in_network_mail_order_pharmacy_benefit_offered',
    'three_month_in_network_mail_order_pharmacy_copayment',
    'three_month_in_network_mail_order_pharmacy_coinsurance',
    'three_month_out_of_network_mail_order_pharmacy_benefit_offered',
    'three_month_out_of_network_mail_order_pharmacy_copayment',
    'three_month_out_of_network_mail_order_pharmacy_coinsurance',
    'sheet_name',
    'src_file_desc', 'src_file_provided_source_date', 'row_status', 'change_date',
    'change_by', 'load_dt'
]
