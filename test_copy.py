...
col_data = col_data.fillna(method='pad', axis=1, limit=6)
...
col_data = col_data.dropna(axis='columns')
...
col_data.to_csv(f'csv/column_combine_rows_123.csv', index=False)
...
for i in range(0, len_col_range_list):
    ...
    excel_read_df = pd.read_excel(path, sheet_name=1, header=2, usecols=num_list)
    ...
    excel_read_df_melt_merge_2 = pd.merge(excel_read_df_melt, excel_read_df_melt_2, on=[id_vars, 'benefit_name'])

    excel_read_df_melt_merge_3 = pd.merge(excel_read_df_melt_merge_2, excel_read_df_melt_3, on=[id_vars, 'benefit_name'])
    del excel_read_df_melt_merge_2
    excel_read_df_melt_merge_4 = pd.merge(excel_read_df_melt_merge_3, excel_read_df_melt_4, on=[id_vars, 'benefit_name'])
    del excel_read_df_melt_merge_3
    excel_read_df_melt_merge_5 = pd.merge(excel_read_df_melt_merge_4, excel_read_df_melt_5, on=[id_vars, 'benefit_name'])
    del excel_read_df_melt_merge_4
    excel_read_df_melt_merge_6 = pd.merge(excel_read_df_melt_merge_5, excel_read_df_melt_6, on=[id_vars, 'benefit_name'])
    del excel_read_df_melt_merge_5

    all_data = all_data.append(excel_read_df_melt_merge_6, ignore_index=True)

    del excel_read_df_melt_merge_6
